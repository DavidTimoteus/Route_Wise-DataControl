                            ...
                            <div class="table-responsive">
                                <form action="{{route('simpan_alternatif')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="nama_alternatif" name="nama_alternatif" class="form-control" placeholder="Nama Toko">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="waktu_tempuh" name="waktu_tempuh" class="form-control" placeholder="Waktu Tempuh">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="jumlah_permintaan" name="jumlah_permintaan" class="form-control" placeholder="Jumlah Permintaan">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="biaya" name="biaya" class="form-control" placeholder="Biaya">
                                    </div>
                                    <div class="form-group">
