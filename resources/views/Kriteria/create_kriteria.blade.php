                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{route('simpan_kriteria')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="number" id="bobot" name="bobot" class="form-control" placeholder="Bobot Kriteria">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="ml-auto" style="background-color: rgb(50, 205, 50); border-radius: 5px; border: none; width: 110px; height: 35px;">
                                            <a style="color: white; text-decoration: none;" href="{{Route('create_kriteria')}}"><strong>Simpan Data </strong></a>
                                        </button>
                                    </div>
                                </form>
                            </div>
