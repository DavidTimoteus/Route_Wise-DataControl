            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center mb-4">
                        <i class="fa-solid fa-user-plus" style="font-size: 25px; margin-right: 10px;"></i>
                            ...
                            <div class="table-responsive">
                                <form action="{{route('simpan_pengguna')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="text" id="nama_lengkap" name="nama_lengkap" class="form-control" placeholder="Nama Pengguna">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="ml-auto" style="background-color: rgb(50, 205, 50); border-radius: 5px; border: none; width: 110px; height: 35px;">
                                            <a style="color: white; text-decoration: none;" href="{{Route('create_pengguna')}}"><strong>Simpan Data </strong></a>
                                        </button>
                                    </div>
                                </form>
                            </div>
