                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="/update_alternatif/{{$dtAlternatif->id}}" method="post">
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        <input type="text" id="nama_alternatif" name="nama_alternatif" class="form-control" placeholder="Nama Toko" value="{{$dtAlternatif->nama_alternatif}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="waktu_tempuh" name="waktu_tempuh" class="form-control" placeholder="Waktu Tempuh" value="{{$dtAlternatif->waktu_tempuh}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="jumlah_permintaan" name="jumlah_permintaan" class="form-control" placeholder="Jumlah Permintaan" value="{{$dtAlternatif->jumlah_permintaan}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="biaya" name="biaya" class="form-control" placeholder="Biaya" value="{{$dtAlternatif->biaya}}">
                                    </div>
                                    <div class="form-group">
                                        <input type="number" id="jarak" name="jarak" class="form-control" placeholder="Jarak" value="{{$dtAlternatif->jarak}}">
                                    </div>
                                    <div class="form-group">
                                        <button type="submit" class="ml-auto" style="background-color: rgb(50, 205, 50); border-radius: 5px; border: none; width: 110px; height: 35px;">
                                            <a style="color: white; text-decoration: none;" href="{{Route('create_alternatif')}}"><strong>Ubah Data </strong></a>
                                        </button>
                                    </div>
                                </form>
                            </div>
